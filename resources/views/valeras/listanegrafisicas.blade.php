...
@section('sub_title', 'Lista negra de la valera: ' . $valera->cuentae->agencia->NOMBRE)
...
@section('modal')
	<div id="Modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<form action="/valeras_fisicas/listanegra/agregar" method="POST">
	...
	<div id="ModalRemover" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
		<div class="modal-dialog"  style="min-width: 50%">
			<div class="modal-content">
				...
				<form action="/valeras_fisicas/listanegra/remover" method="POST">
					<div class="modal-body">
						<div class="row form-group">
							<div class="col-md-3">
...
@section('script')
	<script>
		...
		function toexcel(){
			...
			$.ajax({
				method: "GET",
				url: "/valeras_fisicas/{{$valera->id}}/listanegra/exportar"
			})
