            ...
            <div id="container-main">
                <div class="accordion-container">
                    ...
                    <div class="accordion-content" id="politicas">
                        ...
                        <br>
                        <ul>
                            <li>Prohibir a los trabajadores y personal contratista de JADMIN., el consumo de   bebidas alcohólicas   y   drogas   psicoactivas   durante   la   ejecución   de actividades laborales, sean éstas en oficina o en campo.</li>
                        ...
                        <hr>
                        <p>Es compromiso de JADMIN., establecer actividades de promoción y prevención de incidentes en vía pública, por ello todos sus trabajadores y contratistas, son responsables en la participación de las actividades que desarrolle la empresa con el fin de disminuir la probabilidad de ocurrencia de incidentes que puedan afectar la integridad física, mental y social de los contratistas y sus trabajadores, la comunidad en general y el medio ambiente.</p>
                        <p>Para cumplir este propósito JADMIN., se basa en los siguientes parámetros:</p>
                        <br>
                        <ul>
                            ...
                            <li>Los  trabajadores  y  contratistas  son  responsables  de  la  aplicación  de  las disposiciones establecidas y divulgadas por JADMIN., en el manual de seguridad vial.</li>
                ...
                <div class="accordion-container">
                    ...
                    <div class="accordion-content" id="trabajo">
                        Descarga el <a href="/JADMIN/informacion_empresa/reglamento_interno_trabajo" target="_blank">Reglamento Interno de Trabajo <i class="fa fa-download" aria-hidden="true"></i></a>.
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    ...
                    <div class="accordion-content" id="seguridad">
                        Descarga el <a href="/JADMIN/informacion_empresa/reglamento_seguridad_higiene" target="_blank">Reglamento higiene y seguridad industrial <i class="fa fa-download" aria-hidden="true"></i></a>.
                    </div>
                </div>
