    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link active" href="/historial/recargas/{{$cuenta->id}}">Historial de Recargas</a>

            </li>

            <li class="nav-item">

              <a class="nav-link" href="/historial/consumos/{{$cuenta->id}}">Historial de Consumos</a>
        ...
        <div class="tab-content">
            ...
            <div id="home" class="tab-pane active" style="min-height: 500px"><br>
                    ...
                    <div class="table-responsive" id="listar">
                        ...
                        <table class="table  table-bordered" id="tab_listar" style="table-layout: fixed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $recarga->tiporecarga}}</td>

                                    <td>${{ number_format($recarga->valor)}}</td>

                                    <td>@if ($recarga->sucursal != null)

                                            {{ $recarga->sucursal->nombre}}
                                    ...
                                    <td>@if ($recarga->user != null)

                                            {{$recarga->user->identificacion}}, {{$recarga->user->nombres}}
                        ...
                        @if(method_exists($recargas,'links'))
            ...
            <div id="menu1" class="tab-pane fade" style="min-height: 500px"><br>
        ...
        if($("#desde").val() != ""){
            $.ajax({
                ...
                data: { 'tipo': 'Recargas', 
                    ...
                    filename = "Historial de Recargas.xlsx";
